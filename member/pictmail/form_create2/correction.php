...
*/
	...
	if(is_null($data)){
		...
		*/
		...
		$url_mess = "http://www.rabbit-mail.jp/member/pictmail/form_create2/confirmForm.php?u_id=$user_id&f_id=$f_id";
		$url_mess2 ="http://www.rabbit-mail.jp/member/pictmail/form_create2/m-confirmForm.php?u_id=$user_id&f_id=$f_id";
