...
*********************************************/
    ...
    class SQLData extends base_DB{
        ...
        function getNameCheck()      {return $this->name_check;}
        ...
        function setNameCheck($name_check)            {$this->name_check       = $name_check;}
        ...
        *******************************************************/
        ...
        function getFormId($user_id){
            ...
            //SQL文発行
            $sql = "select applicant_id from td_form_create where user_id =$user_id";
        ...
        *******************************************************/
        ...
        function insertFormData(){
            ...
            //SQL文発行
            $sql = "insert into td_form_create(".
                    "applicant_id,form_name,form_header,".
                    "$param,$check_data,thk_url,del_flag,".
                    "dt,user_id,name_check) values(".
                    "nextval('td_form_create_applicant_id_seq'),'$form_name',".
                    "'$form_header',$param_val,".
                    "$check_val,'$thk_url',$this->del_flag,".
                    "'now()',$this->user_id,$this->name_check)";
        ...
        function updateFormData(){
            ...
            //SQL文発行
            $sql = "update td_form_create set form_name='$form_name',".
                    "form_header='$form_header',$param,".
                    "$check_data,".
                    "thk_url='$thk_url',del_flag='$this->del_flag',".
                    "dt='now()',name_check='$this->name_check' ".
        ...
        *******************************************************/
        ...
        function getSettingMailData($user_id){
            ...
            //SQL文発行
            $sql = "select * from td_setting_thankmail where user_id = $user_id";
        ...
        function insertSettingMailData(){
            ...
            //SQL文を発行
            $sql = "insert into td_setting_thankmail values(nextval('td_setting_thankmail_applicant_id_seq'),".
        ...
        function updateSettingMailData(){
            ...
            //SQL文発行
            $sql = "update td_setting_thankmail set sendmail_flag=$sendMail,".
        ...
        //ユーザーIDよりサンキューメール設定情報取得
        function getSettingMail3Data($user_id){
        ...
        //修正データをDBへ保存
        function updateSettingMail3Data(){
            ...
            //SQL文発行
            $sql = "update td_setting_thankmail3 set sendmail_flag=$sendMail,".
                    "transmit_name='$transmit_name',transmit_mailadd='$transmit_mailadd',".
                    "return_err='$return_err',subject='$subject',text_mess='$text_mess',".
                    "html_flag=$use_html,html_mess='$html_mess',del_flag=$this->del_flag,".
                    "mobail_flag=$this->use_mobail,mobail_mess='$mobail_mess',".
        ...
        //新規データをDBへ保存
        function insertSettingMail3Data(){
            ...
            //SQL文を発行
            $sql = "insert into td_setting_thankmail3 values(nextval('td_setting_thankmail3_applicant_id_seq'),".
            "$sendMail,'$transmit_name','$transmit_mailadd','$return_err',".
            "'$subject','$text_mess',$use_html,'$html_mess',$this->del_flag,".
            "'now()',$this->user_id,$this->use_mobail,'$mobail_mess')";
            //クエリ実行
        ...
        *******************************************************/
        ...
        function showUserData($user_id){
            ...
            //SQL文発行
            $sql = "select name_family,name_first,user_mail_add,dt,applicant_id from td_userdata ".
        ...
        *******************************************************/
        ...
        function detailed($app_id){
            ...
            //SQL文発行
            $sql = "select * from td_userdata where applicant_id=$app_id";
        ...
        *******************************************************/
        ...
        function getcsvData($user_id){
            ...
            //フィールド名取得用SQL発行
            $sql = "select param_name1,param_name2,param_name3,param_name4,param_name5 from td_userdata where user_id=$user_id";
            ...
            //SJISへエンコードしCSVへ書き込み
            echo(mb_convert_encoding($csvStr,"SJIS","EUC-JP"));
            
            //レコード用SQL文発行
            $sql = "select applicant_id,name_family,name_first,user_mail_add,".
                    "param1,param2,param3,param4,param5,dt from td_userdata where user_id=$user_id";
        ...
        *******************************************************/
        ...
        function delUserAllData($user_id){
            ...
            //SQL文発行
            $sql = "delete from td_userdata where user_id=$user_id";
        ...
        function delUserData($user_id,$app_id){
            ...
            //SQL文発行
            $sql = "delete from td_userdata where user_id=$user_id and applicant_id=$app_id";
