...
*/
  ...
  if( _TEST_ ){
    define('_NAME_FROM_',  '[TEST]お客様登録担当者');
    define('_NAME_TO_',    '[TEST]お客様登録担当者');
  ...
  // Html
  define('_HTML_PG_BASE_',    _ROOT_PG_HTML_.'campaign_base.html' );
  define('_HTML_PG_MENU_',    _ROOT_PG_HTML_.'campaign_menu.html' );
  define('_HTML_PG_WRITE_',   _ROOT_PG_HTML_.'campaign_write.html' );
  define('_HTML_PG_CONFIRM_', _ROOT_PG_HTML_.'campaign_confirm.html' );
  define('_HTML_PG_FINISH_',  _ROOT_PG_HTML_.'campaign_finish.html' );
