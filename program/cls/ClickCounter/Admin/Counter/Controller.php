...
//    parent::__construct($db);
  ...
  function setDistribution()
  {
    ...
    switch($this->bean->getVar('submit_key')){
      // update-list-search
      case 'update-list-search':
        $this->setUpdateListSearch();
        break ;
      // update-list
      case 'update-list':
        $this->setUpdateList();
        break ;
      // delete-list-search
      case 'delete-list-search':
        $this->setDeleteListSearch();
        break ;
      // delete-list
      case 'delete-list':
        $this->setDeleteList();
  ...
  function setUpdateListSearch()
  {
    ...
    $this->bean->setVar('action', 'update-list-search');

    $this->manager->setUpdateListSearch() ;
    $this->viewer->setUpdateListSearch();
    return ;
  }
  // update-list
  ...
  function setDeleteListSearch()
  {
    ...
    $this->bean->setVar('action', 'delete-list-search');

    $this->manager->setDeleteListSearch() ;
    $this->viewer->setDeleteListSearch();
    return ;
  }
  // delete-list
  ...
  {
    $this->bean->setSession('mode', 'non_category');
    $this->bean->setVar('action', 'non_category');
    $this->manager->setNonCategory();
    $this->viewer->setNonCategory();
    return ;
  }
  ...
  function setStart()
  {
    ...
    if(! $cc_setup->isCheckCategoryNum() ){
      $this->bean->setVar('submit_key', 'non_category') ;
    }
  }
