...
//    parent::__construct($db, $bean);
  ...
  function init()
  {
    ...
    $this->bean->setInput('cc_ip_id', "");
    $this->bean->setInput('title', "");
    $this->bean->setInput('ip', "");
  ...
  function setConvert()
  {
    ...
    $inputs['url']           = $conv->getConvert($inputs['ip'],"as3");
  ...
  function setInsertDb()
  {
    ...
    require_once PHP_PATH . '/ORMap/TdCcIp.php';
    $db_cc = new TdCcIp($this->db, $this->bean);
