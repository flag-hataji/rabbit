...
class Manager extends Html {
  ...
  function setSessionPageNum($place=False){
    ...
    if ($_SESSION[_SESSION_MODE_][_SESSION_NAME_]['page'] < 0) {
  ...
  function setSessionSeekFormat(){
    ...
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax_1'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax_2'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax_3'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['tel'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['comment'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['ip'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['host'] = "";
    $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['medium_id']  = "";
  }
  ...
  function setSessionSeek(){
    if(isset($_POST['seekS'])){
      ...
      $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax_1'] = $_POST['seekS']['fax_1'];
      $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax_2'] = $_POST['seekS']['fax_2'];
      $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax_3'] = $_POST['seekS']['fax_3'];
      $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['ip'] = $_POST['seekS']['ip'];
      $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['host'] = $_POST['seekS']['host'];
      $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['medium_id'] = $_POST['seekS']['medium_id'];
      ...
      if($_POST['seekS']['fax_1']!="" && $_POST['seekS']['fax_2']!="" && $_POST['seekS']['fax_3']!="" ){
        $_SESSION[_SESSION_MODE_][_SESSION_NAME_]['seekS']['fax'] = "{$_POST['seekS']['fax_1']}-{$_POST['seekS']['fax_2']}-{$_POST['seekS']['fax_3']}";
      }
  ...
  function setDbToInput(){
    ...
    $column .= "tmain.birthday,";
    $column .= "tmain.flag_gender,";
...
*/
    ...
    if( !$Check->isInput($this->inputS['id']) ){
      ...
      $query  = "SELECT count(tmain.user_id) FROM td_user AS tmain ";
      $query .= " JOIN td_pictmail ON td_pictmail.user_id=tmain.user_id";
      $query .= " WHERE td_pictmail.flag_del!=1 AND tmain.id='{$this->inputS['id']}'";
