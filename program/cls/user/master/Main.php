...
*/
  ...
  define('_PG_URL_RENEW_USER_WRITE_', "renew.php?get=write&mode=renew&user_id=#user_id#");
  ...
  define('_PG_URL_CC_USER_',          _PG_URL_."index.php?get=cc&mode=renew&user_id=#user_id#");
  define('_PG_URL_STEPMAIL_USER_',    _PG_URL_."index.php?get=stepmail&mode=renew&user_id=#user_id#");
