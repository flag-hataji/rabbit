...
/*
	//hataji追加
        $Query->setQueryInsertStepmail($this->Manager);
        $Mailer->sendMailFinish($Viewer->setViewDataS($this->Manager->inputS),$this->Manager->nameS);
*/
        $this->Manager->setSessionLogin();
/*
        sleep(1);
        header("location:"._PG_URL_FINISH_);
        exit;
*/
      }else{
