...
*/
    ...
    function sendMailError($num=False,$ex=False){
      ...
      if($subjectMaster!="" && $messageMaster!=""){
        //$this->sendMailMaster($subjectMaster,$messageMaster);
        $Mail->normalMb_send_mail('info@rabbit-mail.jp', 'masaki@itm.ne.jp,hataji@itm.ne.jp,msystem@itm.ne.jp', $subject, $message );
      }
    ...
    function sendMailMaster($subject=False,$message=False){
      ...
      $Mail->normalMb_send_mail('info@rabbit-mail.jp', 'masaki@itm.ne.jp,hataji@itm.ne.jp', $subject, $message );
