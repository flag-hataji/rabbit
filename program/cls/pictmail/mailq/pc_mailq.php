...
//if ( isset($argv[2]) ){
//	// TEST
//	define("_EXE_STR_",  "/var/www/vhosts/test.itm-asp.com/html/pictmail/mailq/pc_mailq"); // 二重起動防止
//}else{

	// 本番
	define("_EXE_STR_",  " /var/www/vhosts/www.rabbit-mail.jp/html/program/cls/pictmail/mailq/pc_mailq"); // 二重起動防止
...
$Mailq = new Mailq(true);	// true=PC用で起動
...
if ( $exe_cnt >= 2 ) {
	...
	// 管理者宛にメール送信
	$subject = "[rabbit-mail.jp MAIL]PC 2重起動発生";
	$body    = "\n";
