...
class Mailer{
  ...
  // メール送信：完了
  function sendMailFinish($dataS=False){
    ...
    $dataS['price_month6'] = sprintf('%18s',$dataS['price_month6']);
    $dataS['price_first']  = sprintf('%18s',$dataS['price_first']);
    $dataS['price_total']  = sprintf('%18s',$dataS['price_total']);
    ...
    $messageUser = str_replace("#plan#",$dataS['plan'],$messageUser);
    $messageUser = str_replace("#auto_money#",$dataS['auto_money'],$messageUser);
    $messageUser = str_replace("#pay#",$dataS['pay'],$messageUser);
    ...
    $messageMaster  = str_replace("#plan#",$dataS['plan'],$messageMaster);
    $messageMaster  = str_replace("#auto_money#",$dataS['auto_money'],$messageMaster);
    $messageMaster  = str_replace("#pay#",$dataS['pay'],$messageMaster);
