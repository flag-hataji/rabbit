...
*/
  ...
  define('_PG_URL_RENEW_SEEK_',       _PG_URL_."change.php?get=seek&mode=renew");
  define('_PG_URL_RENEW_LIST_',       _PG_URL_."change.php?get=list&mode=renew");
  define('_PG_URL_RENEW_USER_WRITE_', _PG_URL_."change.php?get=write&mode=renew&user_id=#user_id#");
  define('_PG_URL_DELETE_USER_',      _PG_URL_."change.php?get=delete&mode=renew&user_id=#user_id#");
  define('_PG_URL_RENEW_PLAN_WRITE_', _URL_ADMIN_."pictmail/change.php?get=write&mode=renew&user_id=#user_id#");
  define('_PG_URL_PERMISSION_USER_',  _PG_URL_."change.php?get=permission&mode=renew&user_id=#user_id#");
