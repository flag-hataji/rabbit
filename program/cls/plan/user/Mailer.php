...
class Mailer{
  ...
  function sendMailFinish($isMainS=""){
    ...
    if($_SESSION['user']['plan_pictmail_id']==1 || ($_SESSION['user']['plan_pictmail_id']==7 || $_SESSION['user']['plan_pictmail_id']==10 || $_SESSION['user']['plan_pictmail_id']==11 || $_SESSION['user']['plan_pictmail_id']==12)){
